...
- `webauthn-get`: Request for WebAuthn authentication.
- `webauth-register`: Request for WebAuthn credential registration.
...
### webauthn-get (decrypted, KeePassXC 2.8.0 and newer)
Unencrypted message:
```json
{
    "action": "webauthn-get",
...
### webauthn-register (decrypted, KeePassXC 2.8.0 and newer)
Unencrypted message:
```json
{
